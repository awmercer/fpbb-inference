...
full_data = read.spss("data/raw/ALL_MERGED_WEIGHTED.sav", 
                      use.value.labels = T, 
                      to.data.frame = T, 
                      trim.factor.names = T, 
                      trim_values = T, 
...
saveRDS(np_imputed, "data/cleaned/cleaned_np_civic_data.RDS")



### CPS Civic Engagement
cps_civic = readRDS("data/raw/cps_nov13_civic_adult_benchmarks.RDS") %>% 
